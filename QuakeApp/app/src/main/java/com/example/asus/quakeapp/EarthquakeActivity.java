...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<ItemModel> earthquakes=new ArrayList<>();
        try {
        ...
        for (int i=0;i<jsonArray.length();++i){
            try {
                ...
                earthquakes.add(new ItemModel(magnitude,string1,string2,date,time,url));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
        earthquakelistview=(ListView)findViewById(R.id.list);
        customAdapter adapter=new customAdapter(getApplicationContext(),earthquakes);
